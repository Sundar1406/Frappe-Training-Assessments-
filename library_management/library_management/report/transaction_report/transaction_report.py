...
def get_columns():
	columns = [
		{ 'fieldname':'article', 'label':_('Article'), 'fieldtype':'Link', 'options':'Article', 'width':300 },
		{ 'fieldname':'library_member', 'label':_('Library Member'), 'fieldtype':'Link', 'options':'Library Member', 'width':300 },
		{ 'fieldname':'type','label':_('Type'),'fieldtype':'Select','options':['','Issue','Return'],'width':300 },
		{ 'fieldname':'date','label':_('Date'),'fieldtype':'Date','width':300 },
		{ 'fieldname':'from_date', 'label':_('From Date'), 'fieldtype':'Date', 'width':300},
		{ 'fieldname':'to_date','label':_('To Date'), 'fieldtype':'Date','width':300}
	]
	return columns
